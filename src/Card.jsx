export function Card({ name, title, description, image, light }) {
  return light ? (
    <div className="relative mx-auto h-auto w-11/12 flex-none  snap-center overflow-hidden rounded-2xl bg-secondary shadow-xl md:w-7/12 lg:max-w-md">
    ...
    <div className="relative mx-auto h-auto w-11/12 flex-none  snap-center overflow-hidden rounded-2xl bg-black shadow-xl md:w-7/12  lg:max-w-md ">
      <div className="absolute z-10 p-8">
