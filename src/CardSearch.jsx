...
export const CardSearch = forwardRef(
  ({ name, image, title, description }, ref) => {
    return (
      <>
        <div
          ref={ref}
          className="relative  h-auto w-11/12 flex-none snap-center  overflow-hidden rounded-2xl bg-secondary shadow-xl md:w-7/12 lg:ml-[20%]  lg:max-w-md"
        >
...
export const MotionCardSearch = motion(CardSearch);
